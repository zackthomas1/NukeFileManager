...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.enter_shotinfo_pushButton.setGeometry(QRect(220, 500, 181, 31))
        ...
        self.showCode_comboBox = QComboBox(self.centralwidget)
        self.showCode_comboBox.setObjectName(u"showCode_comboBox")
        self.showCode_comboBox.setGeometry(QRect(110, 420, 401, 31))
