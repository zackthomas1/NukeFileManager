...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scriptBrowser_widget.setGeometry(QRect(0, 20, 551, 771))
        ...
        self.enter_shotinfo_pushButton = QPushButton(self.scriptBrowser_widget)
        self.enter_shotinfo_pushButton.setObjectName(u"enter_shotinfo_pushButton")
        self.enter_shotinfo_pushButton.setGeometry(QRect(210, 500, 181, 31))
        self.enter_shotinfo_pushButton.setFont(font)
        ...
        self.scripts_listView.setGeometry(QRect(20, 9, 511, 341))
